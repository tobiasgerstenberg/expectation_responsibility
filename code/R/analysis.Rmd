---
title: "Lucky or clever? From expectations to attributions of responsibility"
...
df.posteriors = df.posteriors %>%
	...
	mutate(probability = ifelse(experiment == "gardener", str_replace_all(probability,"suboptimal","30"),probability),
				 ...
				 experiment = factor(experiment,levels = c("goalie", "spinner", "gardener", "manager")))%>%
...
for(i in experiment.names[1:2]){
	...
	p = plot.responsibility.no_model(df.plot,2)
	print(p)
	}
}
